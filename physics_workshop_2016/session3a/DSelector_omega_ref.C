#include "DSelector_omega_ref.h"

void DSelector_omega_ref::Init(TTree *locTree)
{
...
Bool_t DSelector_omega_ref::Process(Long64_t locEntry)
{
...
void DSelector_omega_ref::Finalize(void)
{
