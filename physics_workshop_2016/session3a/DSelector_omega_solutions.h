#ifndef DSelector_omega_solutions_h
#define DSelector_omega_solutions_h
...
class DSelector_omega_solutions : public DSelector
{
	public:

		DSelector_omega_solutions(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_omega_solutions(){}
	...
	ClassDef(DSelector_omega_solutions, 0);
};

void DSelector_omega_solutions::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_omega_solutions_h
