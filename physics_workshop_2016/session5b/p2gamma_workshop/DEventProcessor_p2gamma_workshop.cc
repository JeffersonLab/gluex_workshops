...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_p2gamma_workshop()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_p2gamma_workshop()); //register the factory generator
	}
} // "C"
...
// init
//------------------
jerror_t DEventProcessor_p2gamma_workshop::init(void)
{
...
// brun
//------------------
jerror_t DEventProcessor_p2gamma_workshop::brun(jana::JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DEventProcessor_p2gamma_workshop::evnt(jana::JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	const DEventWriterROOT* locEventWriterROOT = NULL;
	locEventLoop->GetSingle(locEventWriterROOT);
	locEventWriterROOT->Fill_DataTrees(locEventLoop, "p2gamma_workshop");

	return NOERROR;
}

int DEventProcessor_p2gamma_workshop::Get_FileNumber(JEventLoop* locEventLoop) const
{
...
// erun
//------------------
jerror_t DEventProcessor_p2gamma_workshop::erun(void)
{
...
// fini
//------------------
jerror_t DEventProcessor_p2gamma_workshop::fini(void)
{
