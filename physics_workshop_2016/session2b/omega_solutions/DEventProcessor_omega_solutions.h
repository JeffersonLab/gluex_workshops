// $Id$
//
//    File: DEventProcessor_omega_solutions.h
// Created: Thu May  5 14:02:58 EDT 2016
// Creator: pmatt (on Linux pmattdesktop.jlab.org 2.6.32-573.22.1.el6.x86_64 x86_64)
//

#ifndef _DEventProcessor_omega_solutions_
#define _DEventProcessor_omega_solutions_
...
#include "DFactoryGenerator_omega_solutions.h"

using namespace jana;
using namespace std;

class DEventProcessor_omega_solutions : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_omega_solutions";}
...
#endif // _DEventProcessor_omega_solutions_
