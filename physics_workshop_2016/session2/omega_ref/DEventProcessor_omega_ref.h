...
#include "DFactoryGenerator_omega_ref.h"

using namespace jana;
using namespace std;

class DEventProcessor_omega_ref : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_omega_ref";}
...
#endif // _DEventProcessor_omega_ref_
