...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_omega_skim_tree()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_omega_skim_tree()); //register the factory generator
	}
} // "C"
...
// init
//------------------
jerror_t DEventProcessor_omega_skim_tree::init(void)
{
...
// brun
//------------------
jerror_t DEventProcessor_omega_skim_tree::brun(jana::JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DEventProcessor_omega_skim_tree::evnt(jana::JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	const DEventWriterROOT* locEventWriterROOT = NULL;
	locEventLoop->GetSingle(locEventWriterROOT);
	locEventWriterROOT->Fill_DataTrees(locEventLoop, "omega_skim_tree");

	return NOERROR;
}

int DEventProcessor_omega_skim_tree::Get_FileNumber(JEventLoop* locEventLoop) const
{
...
// erun
//------------------
jerror_t DEventProcessor_omega_skim_tree::erun(void)
{
...
// fini
//------------------
jerror_t DEventProcessor_omega_skim_tree::fini(void)
{
