// $Id$
//
//    File: DReaction_factory_omega_skim_tree.cc
...
// brun
//------------------
jerror_t DReaction_factory_omega_skim_tree::brun(JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DReaction_factory_omega_skim_tree::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	/************************************************** omega_skim_tree Reaction Definition *************************************************/
	...
	/**************************************************** omega_skim_tree Control Settings ****************************************************/
	...
	/************************************************** omega_skim_tree Pre-Combo Custom Cuts *************************************************/
	...
	/**************************************************** omega_skim_tree Analysis Actions ****************************************************/
...
// fini
//------------------
jerror_t DReaction_factory_omega_skim_tree::fini(void)
{
