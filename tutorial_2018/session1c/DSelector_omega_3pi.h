#ifndef DSelector_omega_3pi_h
#define DSelector_omega_3pi_h
...
class DSelector_omega_3pi : public DSelector
{
	public:

		DSelector_omega_3pi(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_omega_3pi(){}
	...
	private:
		...
		// EXAMPLES:
		TH1F* dHist_BeamDeltaT, *dHist_BeamE;
		TH1F* dHist_MissingMassSquared_weighted, *dHist_MissingMassSquared_prompt, *dHist_MissingMassSquared_accid;

	ClassDef(DSelector_omega_3pi, 0);
};

void DSelector_omega_3pi::Get_ComboWrappers(void)
{
	//Step 0
