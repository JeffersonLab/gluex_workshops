// $Id$
//
//    File: DEventProcessor_p3pi_PiPlusMiss_P4pi0.h
// Created: Wed May  2 14:03:24 EDT 2018
// Creator: jzarling (on Linux ifarm1401.jlab.org 3.10.0-327.el7.x86_64 x86_64)
//

#ifndef _DEventProcessor_p3pi_PiPlusMiss_P4pi0_
#define _DEventProcessor_p3pi_PiPlusMiss_P4pi0_
...
#include "DFactoryGenerator_p3pi_PiPlusMiss_P4pi0.h"

using namespace jana;
using namespace std;

class DEventProcessor_p3pi_PiPlusMiss_P4pi0 : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_p3pi_PiPlusMiss_P4pi0";}
...
#endif // _DEventProcessor_p3pi_PiPlusMiss_P4pi0_
