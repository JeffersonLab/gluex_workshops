// $Id$
//
//    File: DEventProcessor_p3pi_PiMinusMiss_P4.h
// Created: Wed May  2 14:03:24 EDT 2018
// Creator: jzarling (on Linux ifarm1401.jlab.org 3.10.0-327.el7.x86_64 x86_64)
//

#ifndef _DEventProcessor_p3pi_PiMinusMiss_P4_
#define _DEventProcessor_p3pi_PiMinusMiss_P4_
...
class DEventProcessor_p3pi_PiMinusMiss_P4 : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_p3pi_PiMinusMiss_P4";}
...
#endif // _DEventProcessor_p3pi_PiMinusMiss_P4_
