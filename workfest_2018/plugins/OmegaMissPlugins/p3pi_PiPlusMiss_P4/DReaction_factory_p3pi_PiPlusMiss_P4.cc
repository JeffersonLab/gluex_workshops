// $Id$
//
//    File: DReaction_factory_p3pi_PiPlusMiss_P4.cc
// Created: Wed May  2 14:03:24 EDT 2018
// Creator: jzarling (on Linux ifarm1401.jlab.org 3.10.0-327.el7.x86_64 x86_64)
//


#include "DReaction_factory_p3pi_PiPlusMiss_P4.h"
//------------------
// brun
//------------------
jerror_t DReaction_factory_p3pi_PiPlusMiss_P4::brun(JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DReaction_factory_p3pi_PiPlusMiss_P4::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	/************************************************** p3pi_PiPlusMiss_P4 Reaction Definition *************************************************/

	locReaction = new DReaction("p3pi_PiPlusMiss_P4");
	...
	/**************************************************** p3pi_PiPlusMiss_P4 Control Settings ****************************************************/
	...
	string root_out_name = "tree_p3pi_PiPlusMiss_P4_"+m_treeno+".root";
	locReaction->Enable_TTreeOutput(root_out_name, true); //true/false: do/don't save unused hypotheses

	/**************************************************** p3pi_PiPlusMiss_P4 Analysis Actions ****************************************************/
...
// fini
//------------------
jerror_t DReaction_factory_p3pi_PiPlusMiss_P4::fini(void)
{
