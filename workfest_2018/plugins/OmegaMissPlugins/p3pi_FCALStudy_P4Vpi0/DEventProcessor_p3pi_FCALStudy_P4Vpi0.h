// $Id$
//
//    File: DEventProcessor_p3pi_FCALStudy_P4Vpi0.h
// Created: Wed May  2 14:02:29 EDT 2018
// Creator: jzarling (on Linux ifarm1401.jlab.org 3.10.0-327.el7.x86_64 x86_64)
//

#ifndef _DEventProcessor_p3pi_FCALStudy_P4Vpi0_
#define _DEventProcessor_p3pi_FCALStudy_P4Vpi0_
...
#include "DFactoryGenerator_p3pi_FCALStudy_P4Vpi0.h"

using namespace jana;
using namespace std;

class DEventProcessor_p3pi_FCALStudy_P4Vpi0 : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_p3pi_FCALStudy_P4Vpi0";}
...
#endif // _DEventProcessor_p3pi_FCALStudy_P4Vpi0_
