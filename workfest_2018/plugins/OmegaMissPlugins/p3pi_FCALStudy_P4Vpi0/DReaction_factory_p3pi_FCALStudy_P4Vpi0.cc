// $Id$
//
//    File: DReaction_factory_p3pi_FCALStudy_P4Vpi0.cc
// Created: Wed May  2 14:02:29 EDT 2018
// Creator: jzarling (on Linux ifarm1401.jlab.org 3.10.0-327.el7.x86_64 x86_64)
//


#include "DReaction_factory_p3pi_FCALStudy_P4Vpi0.h"
//------------------
// brun
//------------------
jerror_t DReaction_factory_p3pi_FCALStudy_P4Vpi0::brun(JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// evnt
//------------------
jerror_t DReaction_factory_p3pi_FCALStudy_P4Vpi0::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
	...
	/************************************************** p3pi_FCALStudy_P4Vpi0 Reaction Definition *************************************************/

	locReaction = new DReaction("p3pi_FCALStudy_P4Vpi0");
	...
	/**************************************************** p3pi_FCALStudy_P4Vpi0 Control Settings ****************************************************/
	...
	string root_out_name = "tree_p3pi_FCALStudy_P4Vpi0_"+m_treeno+".root";
	locReaction->Enable_TTreeOutput(root_out_name, true); //true/false: do/don't save unused hypotheses

	/**************************************************** p3pi_FCALStudy_P4Vpi0 Analysis Actions ****************************************************/
...
// fini
//------------------
jerror_t DReaction_factory_p3pi_FCALStudy_P4Vpi0::fini(void)
{
