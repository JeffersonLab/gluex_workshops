// $Id$
//
//    File: DReaction_factory_workshop_s5a.cc
...
// init
//------------------
jerror_t DReaction_factory_workshop_s5a::init(void)
{
	// Make as many DReaction objects as desired
	DReactionStep* locReactionStep = NULL;
	DReaction* locReaction = new DReaction("workshop_s5a"); //unique name, feel free to change

	/**************************************************** workshop_s5a Reaction Steps ****************************************************/
	...
	/**************************************************** workshop_s5a Control Variables ****************************************************/
	...
	// locReaction->Enable_TTreeOutput("tree_workshop_s5a.root"); //string is file name (must end in ".root"!!): doen't need to be unique, feel free to change

	/**************************************************** workshop_s5a Analysis Actions ****************************************************/
...
// fini
//------------------
jerror_t DReaction_factory_workshop_s5a::fini(void)
{
