...
extern "C"
{
	void InitPlugin(JApplication *locApplication)
	{
		...
		locApplication->AddProcessor(new DEventProcessor_workshop_s4b()); //register this plugin
		locApplication->AddFactoryGenerator(new DFactoryGenerator_workshop_s4b()); //register the factory generator
	}
} // "C"
...
// init
//------------------
jerror_t DEventProcessor_workshop_s4b::init(void)
{
...
// brun
//------------------
jerror_t DEventProcessor_workshop_s4b::brun(jana::JEventLoop* locEventLoop, int locRunNumber)
{
...
// evnt
//------------------
jerror_t DEventProcessor_workshop_s4b::evnt(jana::JEventLoop* locEventLoop, int locEventNumber)
{
...
// erun
//------------------
jerror_t DEventProcessor_workshop_s4b::erun(void)
{
...
// fini
//------------------
jerror_t DEventProcessor_workshop_s4b::fini(void)
{
