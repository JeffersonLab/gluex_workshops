...
- $0.1 < -t < 0.5$: Nothing particularly special about this region, just done to demonstrate binning in $-t$
- 10 bins from $1.1 < M_{\omega\pi^0} < 1.3$: we'll perform independent fits in these 10 mass bins
